...
function RoadBackground() {
  ...
  const lineColor = isDark ? "rgba(255,255,255,0.3)" : "rgba(0,0,0,0.08)";
  const carStroke = isDark ? "rgba(255,255,255,0.35)" : "rgba(0,0,0,0.12)";
  const carFill = isDark ? "rgba(255,255,255,0.18)" : "rgba(0,0,0,0.04)";
  const carWindow = isDark ? "rgba(255,255,255,0.3)" : "rgba(0,0,0,0.08)";
  const lightGlow = isDark ? "rgba(255,255,255,0.85)" : "rgba(0,0,0,0.3)";
  const lightHalo = isDark ? "rgba(255,255,255,0.15)" : "rgba(0,0,0,0.02)";
    ...
    <div className="pointer-events-none absolute inset-0 z-0">
      ...
      >
        ...
        <g transform="translate(578, 320)">
          ...
          <circle cx="11" cy="28" r="1.5" fill={isDark ? "rgba(255,255,255,0.4)" : "rgba(0,0,0,0.1)"}/>
          <circle cx="34" cy="28" r="4" fill={carFill} stroke={carStroke} strokeWidth="1"/>
          <circle cx="34" cy="28" r="1.5" fill={isDark ? "rgba(255,255,255,0.4)" : "rgba(0,0,0,0.1)"}/>
